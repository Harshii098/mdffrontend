...
function editDatacall(id) {
    ...
    fetch("http://54.244.58.229:8080/server/" + id, {
        method: "GET",
        mode: "cors",
...
function addServer() {
    ...
    fetch("http://54.244.58.229:8080/postserver", {
...
function editData() {
    ...
    fetch("http://54.244.58.229:8080/putserver",  {
...
function getData() {
    fetch("http://54.244.58.229:8080/server").then(
        (res) => res.json()
    ).then((response) => {
        var tmpData = "";
