...
function editDatacall(id) {
    ...
    fetch("http://54.244.58.229:8080/byod/" + id, {
        method: "GET",
        mode: "cors",
...
function addByod() {
    ...
    let payload = getFormData();
     fetch("http://54.244.58.229:8080/postbyod", {
...
function editData() {
    ...
    fetch("http://54.244.58.229:8080/putbyod",  {
...
function getData() {
    fetch("http://54.244.58.229:8080/byod").then(
        (res) => res.json()
    ).then((response) => {
        var tmpData = "";
